...
class DeviceLiveView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_device_live_view)
        ...
        title.setText(devName)

        databaseListener()

        lineData = arrayListOf()

        lineDataSet= LineDataSet(lineData,"Cuadal (m3/s)")
        ...
        lineChart.description.text= "Datos en tiempo real"
    ...
    private fun databaseListener() {
        ...
        val postListener = object: ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@DeviceLiveView, "Failed to read value.", Toast.LENGTH_SHORT).show()
            }
        }
